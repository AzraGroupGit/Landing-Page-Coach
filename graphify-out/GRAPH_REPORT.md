# Graph Report - landing-page-CEO  (2026-08-31)

## Corpus Check
- Large corpus: 71 files · ~535,642 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 212 nodes · 273 edges · 35 communities (13 shown, 22 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.87)
- Token cost: 2,019 input · 444 output
...
- `Hero()` --calls--> `waLink()`  [EXTRACTED]
  src/components/Hero.jsx → src/lib/config.js
...
Cohesion: 0.09
Nodes (29): About(), brands, education, roles, Button(), circle, shell, Footer() (+21 more)
...
### Community 2 - "App & Lint References"
Cohesion: 0.16
Nodes (14): plugins, oxc, react, App(), Clients, Hero(), links, Nav() (+6 more)
...
### Community 11 - "Partner Organizations"
Cohesion: 0.50
...
## Knowledge Gaps
- **85 isolated node(s):** `brands`, `education`, `roles`, `circle`, `shell` (+80 more)
...
- **What connects `brands`, `education`, `roles` to the rest of the system?**
